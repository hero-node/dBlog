  ...
  render() {
    ...
    return (
      <div className="notice-radio">
        <div className={checked ? "radioo checked" : "radioo"} onClick={this.props.check}>通知</div>
        {checked && 
          <div>
            <div className="radioo-input">
              <input type="text" className="lg-input" placeholder="请输入地址" value={address} onChange={addressChange}/>
            </div>
            <div className="radioo-input amount">
              <input type="number" className="lg-input" placeholder="通知金额(eth)" value={amount} onChange={amountChange}/>
            </div>
          </div>
        }
      </div>
