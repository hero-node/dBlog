        ...
        <div className={ visible ? "pop-up-mask show" : "pop-up-mask" } >
          <div className="pop-up">
            <div style={{ width: '350px' }}>
              ...
              <input type="password" className="lg-input" value={pwd} onChange={this.pwdChange}/>
            </div>
            <div className="pop-up-op">
              <div className="op-col">
                <button type="submit"  className="btn" onClick={this.cancel}>Cancel</button>
              </div>
              <div className="op-col">
                <button type="submit"  className="btn" onClick={this.confirm}>Confirm</button>
              </div>
            </div>
          </div>
        </div>
