    ...
    return (
      <header className="App-header">
        <div className="hd-logo">
          <div className="hd-logo-ico"></div>
        </div>
        <div className="search-wrap">
          <input type="text" placeholder="请输入地址,昵称,ens" value={ethAddress} onChange={this.addressChange}/>
          <div className="search-ico" onClick={this.search}></div>
        </div>
        ...
        >
          <div style={{ width: '350px' }}>
            ...
            <input type="text" className="lg-input" value={articleName} onChange={this.articleNameChange}/>
          </div>
        </Modal>
        <div className="expand" onClick={this.props.showMyInfo}>
          <div className="expand-ico"></div>
        </div>
