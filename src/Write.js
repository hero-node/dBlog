...
const contractAddress =
  process.env.CONTRACT_ADDRESS || '0x2F9037c6B5139D7Ce2B750b71693E518c7FFF0A7';
const ensContractAddress =
  ...
  uploadImg = param => {
    ...
    reader.onloadend = e => {
      this.saveImageOnIpfs(param.file).then(hash => {
        param.success({
          url: `http://${HERONODE_ENDPOINT}/_/ipfs/files/${hash}`,
        });
      });
    };
  };
