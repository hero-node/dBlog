...
class Login extends React.Component {
  ...
  render() {
    let { visible, keystore, password, newAccountPwd, isLoading, url }= this.state;
    return (
      <div className="login">
        <div className="logo">
        ...
        <div className="login-box">
          ...
          <div>
            <div className="lg-row">
              <p>Keystore</p>
              <input type="text" className="lg-input" value={keystore} onChange={this.keystoreChange}/>
            </div>
            <div className="lg-row">
              <p>Password</p>
              <input type="password" placeholder="please enter your password" className="lg-input" value={password} onChange={this.passwordChange}/>
            </div>
            <div className="lg-row">
              <button type="submit"  className="button" onClick={this.login}>Login</button>
            </div>
            <div className="lg-row">
              <button type="submit"  className="button btn2" onClick={this.showPwd}>Create Account</button>
            </div>
          </div>
        </div>
        <div className={ visible ? "pop-up-mask show" : "pop-up-mask" } >
          <div className="pop-up">
            <div style={{ width: '350px' }}>
              ...
              <input type="password" className="lg-input" value={newAccountPwd} onChange={this.newAccountPwdChange}/>
            </div>
            <div className="pop-up-op">
              <div className="op-col">
                <button type="submit"  className="btn btn-cancel" onClick={this.cancel}>Cancel</button>
              </div>
              <div className="op-col">
                <button type="submit"  className="btn" onClick={this.createAccount}>Confirm</button>
              </div>
            </div>
          </div>
        </div>
